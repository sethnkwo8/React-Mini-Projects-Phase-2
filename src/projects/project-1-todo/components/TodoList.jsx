    ...
    return (
        <div className='min-h-screen flex flex-col justify-center items-center'>
            <div className=' p-4 flex flex-col justify-center items-center w-full md:w-3/4 rounded-lg border border-black space-y-4'>
                <button className='mx-24 self-end rounded-lg py-4 px-8 text-white bg-blue-400 hover:bg-blue-600 hover:scale-105 transition-all ease-in-out duration-300'>Add Task</button>
